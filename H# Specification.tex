...
\begin{grammar}
	...
	\alt $VarDecl$ | $FuncDecl$ % Variable declaration
	...
	\gtext{FuncDecl} ::=  $Id$\glit{(}$Param$\glit{):} $TypeId$ $FuncBody$ % Const-unassignable
	\alt $AccessMod$ $Id$\glit{(}$Param$\glit{):} $TypeId$ $FuncBody$ % Const-unassignable
	\alt $Id$ \glit{= (}$Param$\glit{):} $TypeId$ $FuncBody$  % Reassignable
	\alt $AccessMod$ $Id$ \glit{= (}$Param$\glit{):} $TypeId$ $FuncBody$  % Reassignable
	\alt $AccessMod$ \glit{const} $Id$ \glit{= (}$Param$\glit{):} $TypeId$ $FuncBody$  % Reassignable
