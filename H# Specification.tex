...
\centering
	\begin{mathparpagebreakable}
		...
		\and
		\infer[T-Addition]
		{\typemodel e_1 \ \texttt{:} \ \tau_1 \rspace \typemodel e_2 \ \texttt{:} \ \tau_2 \rspace \rspace \tau <: \texttt{INumeric}}
		{\typemodel e_1 \ \texttt{+} \ e_2 \typeis{}}
		\and
		\infer[T-DeclVar-NonRef]
		{\typemodel e \ \texttt{:} \ \tau \rspace \tau \notin \eta \rspace \theta'=\theta[x \mapsto \tau'] \rspace \tau'=\texttt{typeof}(t,\gamma) \rspace \tau <: \tau'}
		{\typemodel t \ x \ \texttt{=} \ e \typeis{\theta', \gamma, \eta}}
		\and
		\infer[T-DeclVar-Ref]
		{\typemodel e \ \texttt{:} \ \tau \rspace \tau \in \eta \rspace \theta'=\theta[x \mapsto \texttt{Ref}(\tau')] \rspace \tau'=\texttt{typeof}(t,\gamma) \rspace \tau <: \tau'}
		{\typemodel t \ x \ \texttt{=} \ e \typeis{\theta', \gamma, \eta}}
		\and
		\infer[T-NewObject]
		{\tau = \gamma(t) \rspace \tau=() \rspace \typemodel e_1,\dots, e_n \typeis{\tau_1,\dots,\tau_n}}
